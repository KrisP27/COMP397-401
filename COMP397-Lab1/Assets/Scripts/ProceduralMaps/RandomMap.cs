...
public class RandomMap : MonoBehaviour
{
    ...
    private GameObject GenerateTileOnPerlinNoise(float noiseValue)
    {
        ...
        {
            case <= 0.20f:
                return prefabTilesList[0];
            case <= 0.40f:
                return prefabTilesList[1];
            case <= 0.60f:
                return prefabTilesList[2];
            case <= 0.80f:
                return prefabTilesList[3];
            case <= 1f:
                return prefabTilesList[4];
            default: return prefabTilesList[0];
        }
    }
}
